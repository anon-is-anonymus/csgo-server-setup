...
# Start server
tmux new-session -s "CSGO_Server" -d "cd $csLocation && ./srcds_run -game csgo -console -port $csPort +rcon_password $rconPass +sv_password $serverPass +sv_setsteamaccount $gameToken +tv_port $gotvPort +game_type 0 +game_mode 1 +mapgroup mg_active +map de_dust2"
